    ...
    public class PostModInclusionDAO:BaseDAO
    {
        ...
        public void InsertPostModInclusion(PostModInclusionDTO record)
        {
            ...
            try
            {
                ...
                sqlParam[10] = new SqlParameter("@pi_ach_ind", record.AchInd);
                ...
                sqlParam[15] = new SqlParameter("@pi_dflt_reason", record.DefaultReason);
                ...
                sqlParam[19] = new SqlParameter("@pi_co_borrower_fname", record.CoBorrowerFName);
                sqlParam[20] = new SqlParameter("@pi_co_borrower_lname", record.CoBorrowerLName);
                sqlParam[21] = new SqlParameter("@pi_prop_addr1", record.PropAddr1);
                sqlParam[22] = new SqlParameter("@pi_prop_addr2", record.PropAddr2);
                ...
                sqlParam[27] = new SqlParameter("@pi_contact_addr2", record.ContactAddr2);
                ...
                sqlParam[31] = new SqlParameter("@pi_borrower_home_contact_no", record.BorrowerHomeContactNo);
                sqlParam[32] = new SqlParameter("@pi_borrower_office1_contact_no", record.BorrowerOffice1ContactNo);
                sqlParam[33] = new SqlParameter("@pi_borrower_office2_contact_no", record.BorrowerOffice2ContactNo);
                sqlParam[34] = new SqlParameter("@pi_borrower_other_contact_no", record.BorrowerOtherContactNo);
                sqlParam[35] = new SqlParameter("@pi_borrower_cell1_contact_no", record.BorrowerOffice1ContactNo);
                sqlParam[36] = new SqlParameter("@pi_borrower_cell2_contact_no", record.BorrowerOffice2ContactNo);
                sqlParam[37] = new SqlParameter("@pi_borrower_email", record.BorrowerEmail);
                sqlParam[38] = new SqlParameter("@pi_co_borrower_home_contact_no", record.CoBorrowerHomeContactNo);
                sqlParam[39] = new SqlParameter("@pi_co_borrower_office1_contact_no", record.CoBorrowerOffice1ContactNo);
                sqlParam[40] = new SqlParameter("@pi_co_borrower_office2_contact_no", record.CoBorrowerOffice2ContactNo);
                sqlParam[41] = new SqlParameter("@pi_co_borrower_other_contact_no", record.CoBorrowerOtherContactNo);
                sqlParam[42] = new SqlParameter("@pi_co_borrower_cell1_contact_no", record.CoBorrowerCell1ContactNo);
                sqlParam[43] = new SqlParameter("@pi_co_borrower_cell2_contact_no", record.CoBorrowerCell2ContactNo);
                sqlParam[44] = new SqlParameter("@pi_co_borrower_email", record.CoBorrowerEmail);
                ...
                sqlParam[47] = new SqlParameter("@pi_agency_file_name", record.AgencyFileName);
