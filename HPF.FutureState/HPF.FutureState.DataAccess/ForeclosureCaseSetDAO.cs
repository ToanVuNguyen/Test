...
namespace HPF.FutureState.DataAccess
{
    public class ForeclosureCaseSetDAO : BaseDAO
    {
        ...
        public int InsertForeclosureCase(ForeclosureCaseDTO foreclosureCase)
        {
            ...
            try
            {
                var sqlParam = new SqlParameter[105];
                ...
                sqlParam[60] = new SqlParameter("@pi_case_complete_ind", foreclosureCase.CaseCompleteInd);
                sqlParam[61] = new SqlParameter("@pi_funding_consent_ind", foreclosureCase.FundingConsentInd);
                sqlParam[62] = new SqlParameter("@pi_servicer_consent_ind", foreclosureCase.ServicerConsentInd);
                sqlParam[63] = new SqlParameter("@pi_agency_media_consent_ind", foreclosureCase.AgencyMediaConsentInd);
                sqlParam[64] = new SqlParameter("@pi_agency_success_story_ind", foreclosureCase.AgencySuccessStoryInd);
                sqlParam[65] = new SqlParameter("@pi_borrower_disabled_ind", foreclosureCase.BorrowerDisabledInd);
                sqlParam[66] = new SqlParameter("@pi_co_borrower_disabled_ind", foreclosureCase.CoBorrowerDisabledInd);
                sqlParam[67] = new SqlParameter("@pi_summary_sent_other_cd", foreclosureCase.SummarySentOtherCd);
                ...
                sqlParam[71] = new SqlParameter("@pi_loan_dflt_reason_notes", foreclosureCase.LoanDfltReasonNotes);
                sqlParam[72] = new SqlParameter("@pi_action_items_notes", foreclosureCase.ActionItemsNotes);
                sqlParam[73] = new SqlParameter("@pi_followup_notes", foreclosureCase.FollowupNotes);
                sqlParam[74] = new SqlParameter("@pi_prim_res_est_mkt_value", foreclosureCase.PrimResEstMktValue);
                sqlParam[75] = new SqlParameter("@pi_counselor_id_ref", foreclosureCase.AssignedCounselorIdRef);
                sqlParam[76] = new SqlParameter("@pi_counselor_lname", foreclosureCase.CounselorFname);
                sqlParam[77] = new SqlParameter("@pi_counselor_fname", foreclosureCase.CounselorLname);
                sqlParam[78] = new SqlParameter("@pi_counselor_email", foreclosureCase.CounselorEmail);
                sqlParam[79] = new SqlParameter("@pi_counselor_phone", foreclosureCase.CounselorPhone);
                sqlParam[80] = new SqlParameter("@pi_counselor_ext", foreclosureCase.CounselorExt);
                sqlParam[81] = new SqlParameter("@pi_discussed_solution_with_srvcr_ind", foreclosureCase.DiscussedSolutionWithSrvcrInd);
                sqlParam[82] = new SqlParameter("@pi_worked_with_another_agency_ind", foreclosureCase.WorkedWithAnotherAgencyInd);
                sqlParam[83] = new SqlParameter("@pi_contacted_srvcr_recently_ind", foreclosureCase.ContactedSrvcrRecentlyInd);
                sqlParam[84] = new SqlParameter("@pi_has_workout_plan_ind", foreclosureCase.HasWorkoutPlanInd);
                sqlParam[85] = new SqlParameter("@pi_srvcr_workout_plan_current_ind", foreclosureCase.SrvcrWorkoutPlanCurrentInd);
                sqlParam[86] = new SqlParameter("@pi_primary_residence_ind", foreclosureCase.PrimaryResidenceInd);
                sqlParam[87] = new SqlParameter("@pi_realty_company", foreclosureCase.RealtyCompany);
                sqlParam[88] = new SqlParameter("@pi_property_cd", foreclosureCase.PropertyCd);
                sqlParam[89] = new SqlParameter("@pi_for_sale_ind", foreclosureCase.ForSaleInd);
                ...
                sqlParam[94] = new SqlParameter("@pi_military_service_cd", foreclosureCase.MilitaryServiceCd);
                sqlParam[95] = new SqlParameter("@pi_household_gross_annual_income_amt", foreclosureCase.HouseholdGrossAnnualIncomeAmt);
                sqlParam[96] = new SqlParameter("@pi_intake_credit_score", foreclosureCase.IntakeCreditScore);
                sqlParam[97] = new SqlParameter("@pi_Intake_credit_bureau_cd ", foreclosureCase.IntakeCreditBureauCd);
                sqlParam[98] = new SqlParameter("@pi_create_dt", NullableDateTime(foreclosureCase.CreateDate));
                sqlParam[99] = new SqlParameter("@pi_create_user_id", foreclosureCase.CreateUserId);
                sqlParam[100] = new SqlParameter("@pi_create_app_name", foreclosureCase.CreateAppName);
                sqlParam[101] = new SqlParameter("@pi_chg_lst_dt", NullableDateTime(foreclosureCase.ChangeLastDate));
                sqlParam[102] = new SqlParameter("@pi_chg_lst_user_id", foreclosureCase.ChangeLastUserId);
                sqlParam[103] = new SqlParameter("@pi_chg_lst_app_name", foreclosureCase.ChangeLastAppName);
                sqlParam[104] = new SqlParameter("@po_fc_id", SqlDbType.Int) { Direction = ParameterDirection.Output };                
                //</Parameter>            
                command.Parameters.AddRange(sqlParam);
                command.CommandType = CommandType.StoredProcedure;            
                command.Transaction = this.trans;            
                command.ExecuteNonQuery();                
                foreclosureCase.FcId = ConvertToInt(sqlParam[104].Value);
            }
            catch (Exception Ex)
            {                
                throw ExceptionProcessor.Wrap<DataAccessException>(Ex);
        ...
        {            
            ...
            try
            {
                ...
                sqlParam[66] = new SqlParameter("@pi_agency_success_story_ind", foreclosureCase.AgencySuccessStoryInd);
                sqlParam[67] = new SqlParameter("@pi_borrower_disabled_ind", foreclosureCase.BorrowerDisabledInd);
                sqlParam[68] = new SqlParameter("@pi_co_borrower_disabled_ind", foreclosureCase.CoBorrowerDisabledInd);
                sqlParam[69] = new SqlParameter("@pi_summary_sent_other_cd", foreclosureCase.SummarySentOtherCd);
                sqlParam[70] = new SqlParameter("@pi_summary_sent_other_dt", NullableDateTime(foreclosureCase.SummarySentOtherDt));
                sqlParam[71] = new SqlParameter("@pi_summary_sent_dt", NullableDateTime(foreclosureCase.SummarySentDt));
                sqlParam[72] = new SqlParameter("@pi_occupant_num", foreclosureCase.OccupantNum);
                sqlParam[73] = new SqlParameter("@pi_loan_dflt_reason_notes", foreclosureCase.LoanDfltReasonNotes);
                sqlParam[74] = new SqlParameter("@pi_action_items_notes", foreclosureCase.ActionItemsNotes);
                sqlParam[75] = new SqlParameter("@pi_followup_notes", foreclosureCase.FollowupNotes);
                sqlParam[76] = new SqlParameter("@pi_prim_res_est_mkt_value", foreclosureCase.PrimResEstMktValue);
                sqlParam[77] = new SqlParameter("@pi_counselor_id_ref", foreclosureCase.AssignedCounselorIdRef);
                sqlParam[78] = new SqlParameter("@pi_counselor_lname", foreclosureCase.CounselorFname);
                sqlParam[79] = new SqlParameter("@pi_counselor_fname", foreclosureCase.CounselorLname);
                sqlParam[80] = new SqlParameter("@pi_counselor_email", foreclosureCase.CounselorEmail);
                sqlParam[81] = new SqlParameter("@pi_counselor_phone", foreclosureCase.CounselorPhone);
                sqlParam[82] = new SqlParameter("@pi_counselor_ext", foreclosureCase.CounselorExt);
                sqlParam[83] = new SqlParameter("@pi_discussed_solution_with_srvcr_ind", foreclosureCase.DiscussedSolutionWithSrvcrInd);
                sqlParam[84] = new SqlParameter("@pi_worked_with_another_agency_ind", foreclosureCase.WorkedWithAnotherAgencyInd);
                sqlParam[85] = new SqlParameter("@pi_contacted_srvcr_recently_ind", foreclosureCase.ContactedSrvcrRecentlyInd);
                sqlParam[86] = new SqlParameter("@pi_has_workout_plan_ind", foreclosureCase.HasWorkoutPlanInd);
                sqlParam[87] = new SqlParameter("@pi_srvcr_workout_plan_current_ind", foreclosureCase.SrvcrWorkoutPlanCurrentInd);
                sqlParam[88] = new SqlParameter("@pi_primary_residence_ind", foreclosureCase.PrimaryResidenceInd);
                sqlParam[89] = new SqlParameter("@pi_realty_company", foreclosureCase.RealtyCompany);
                sqlParam[90] = new SqlParameter("@pi_property_cd", foreclosureCase.PropertyCd);
                sqlParam[91] = new SqlParameter("@pi_for_sale_ind", foreclosureCase.ForSaleInd);
                sqlParam[92] = new SqlParameter("@pi_home_sale_price", foreclosureCase.HomeSalePrice);
                sqlParam[93] = new SqlParameter("@pi_home_purchase_year", foreclosureCase.HomePurchaseYear);
                sqlParam[94] = new SqlParameter("@pi_home_purchase_price", foreclosureCase.HomePurchasePrice);
                sqlParam[95] = new SqlParameter("@pi_Home_Current_Market_Value", foreclosureCase.HomeCurrentMarketValue);
                sqlParam[96] = new SqlParameter("@pi_military_service_cd", foreclosureCase.MilitaryServiceCd);
                sqlParam[97] = new SqlParameter("@pi_household_gross_annual_income_amt", foreclosureCase.HouseholdGrossAnnualIncomeAmt);
                sqlParam[98] = new SqlParameter("@pi_intake_credit_score", foreclosureCase.IntakeCreditScore);
                sqlParam[99] = new SqlParameter("@pi_Intake_credit_bureau_cd ", foreclosureCase.IntakeCreditBureauCd);
                ...
                sqlParam[103] = new SqlParameter("@pi_fc_id", foreclosureCase.FcId);                
                //</Parameter>            
                command.Parameters.AddRange(sqlParam);
                command.CommandType = CommandType.StoredProcedure;            
                command.Transaction = this.trans;            
