    ...
    public class ForeclosureCaseSetDAO : BaseDAO
    {
        ...
        public int? InsertForeclosureCase(ForeclosureCaseDTO foreclosureCase)
        {
            ...
            try
            {
                ...
                sqlParam[17] = new SqlParameter("@pi_counseling_duration_cd", NullableString(foreclosureCase.CounselingDurationCd));
                sqlParam[18] = new SqlParameter("@pi_gender_cd", NullableString(foreclosureCase.GenderCd));
                sqlParam[19] = new SqlParameter("@pi_borrower_fname", NullableString(foreclosureCase.BorrowerFname));
                sqlParam[20] = new SqlParameter("@pi_borrower_lname", NullableString(foreclosureCase.BorrowerLname));
                sqlParam[21] = new SqlParameter("@pi_borrower_mname", NullableString(foreclosureCase.BorrowerMname));
                sqlParam[22] = new SqlParameter("@pi_mother_maiden_lname", NullableString(foreclosureCase.MotherMaidenLname));
                sqlParam[23] = new SqlParameter("@pi_borrower_ssn", NullableString(foreclosureCase.BorrowerSsn));
                sqlParam[24] = new SqlParameter("@pi_borrower_last4_SSN", NullableString(foreclosureCase.BorrowerLast4Ssn));
                sqlParam[25] = new SqlParameter("@pi_borrower_DOB", NullableDateTime(foreclosureCase.BorrowerDob));
                sqlParam[26] = new SqlParameter("@pi_co_borrower_fname", NullableString(foreclosureCase.CoBorrowerFname));
                sqlParam[27] = new SqlParameter("@pi_co_borrower_lname", NullableString(foreclosureCase.CoBorrowerLname));
                sqlParam[28] = new SqlParameter("@pi_co_borrower_mname", NullableString(foreclosureCase.CoBorrowerMname));
                sqlParam[29] = new SqlParameter("@pi_co_borrower_ssn", NullableString(foreclosureCase.CoBorrowerSsn));
                sqlParam[30] = new SqlParameter("@pi_co_borrower_last4_SSN", NullableString(foreclosureCase.CoBorrowerLast4Ssn));
                sqlParam[31] = new SqlParameter("@pi_co_borrower_DOB", NullableDateTime(foreclosureCase.CoBorrowerDob));
                sqlParam[32] = new SqlParameter("@pi_primary_contact_no", NullableString(foreclosureCase.PrimaryContactNo));
                sqlParam[33] = new SqlParameter("@pi_second_contact_no", NullableString(foreclosureCase.SecondContactNo));
                sqlParam[34] = new SqlParameter("@pi_email_1", NullableString(foreclosureCase.Email1));
                sqlParam[35] = new SqlParameter("@pi_email_2", NullableString(foreclosureCase.Email2));
                sqlParam[36] = new SqlParameter("@pi_contact_addr1", NullableString(foreclosureCase.ContactAddr1));
                sqlParam[37] = new SqlParameter("@pi_contact_addr2", NullableString(foreclosureCase.ContactAddr2));
                sqlParam[38] = new SqlParameter("@pi_contact_city", NullableString(foreclosureCase.ContactCity));
                sqlParam[39] = new SqlParameter("@pi_contact_state_cd", NullableString(foreclosureCase.ContactStateCd));
                sqlParam[40] = new SqlParameter("@pi_contact_zip", NullableString(foreclosureCase.ContactZip));
                sqlParam[41] = new SqlParameter("@pi_contact_zip_plus4", NullableString(foreclosureCase.ContactZipPlus4));
                sqlParam[42] = new SqlParameter("@pi_prop_addr1", NullableString(foreclosureCase.PropAddr1));
                sqlParam[43] = new SqlParameter("@pi_prop_addr2", NullableString(foreclosureCase.PropAddr2));
                sqlParam[44] = new SqlParameter("@pi_prop_city", NullableString(foreclosureCase.PropCity));
                sqlParam[45] = new SqlParameter("@pi_prop_state_cd", NullableString(foreclosureCase.PropStateCd));
                sqlParam[46] = new SqlParameter("@pi_prop_zip", NullableString(foreclosureCase.PropZip));
                sqlParam[47] = new SqlParameter("@pi_prop_zip_plus_4", NullableString(foreclosureCase.PropZipPlus4));
                sqlParam[48] = new SqlParameter("@pi_bankruptcy_ind", NullableString(foreclosureCase.BankruptcyInd));
                sqlParam[49] = new SqlParameter("@pi_bankruptcy_attorney", NullableString(foreclosureCase.BankruptcyAttorney));
                sqlParam[50] = new SqlParameter("@pi_bankruptcy_pmt_current_ind", NullableString(foreclosureCase.BankruptcyPmtCurrentInd));
                ...
                sqlParam[59] = new SqlParameter("@pi_fc_notice_received_ind", NullableString(foreclosureCase.FcNoticeReceiveInd));
                sqlParam[60] = new SqlParameter("@pi_funding_consent_ind", NullableString(foreclosureCase.FundingConsentInd));
                sqlParam[61] = new SqlParameter("@pi_servicer_consent_ind", NullableString(foreclosureCase.ServicerConsentInd));
                sqlParam[62] = new SqlParameter("@pi_agency_media_interest_ind", NullableString(foreclosureCase.AgencyMediaInterestInd));
                sqlParam[63] = new SqlParameter("@pi_agency_success_story_ind", NullableString(foreclosureCase.AgencySuccessStoryInd));
                sqlParam[64] = new SqlParameter("@pi_borrower_disabled_ind", NullableString(foreclosureCase.BorrowerDisabledInd));
                sqlParam[65] = new SqlParameter("@pi_co_borrower_disabled_ind", NullableString(foreclosureCase.CoBorrowerDisabledInd));
                sqlParam[66] = new SqlParameter("@pi_summary_sent_other_cd", NullableString(foreclosureCase.SummarySentOtherCd));
                ...
                sqlParam[70] = new SqlParameter("@pi_loan_dflt_reason_notes", NullableString(foreclosureCase.LoanDfltReasonNotes));
                sqlParam[71] = new SqlParameter("@pi_action_items_notes", NullableString(foreclosureCase.ActionItemsNotes));
                ...
                sqlParam[80] = new SqlParameter("@pi_discussed_solution_with_srvcr_ind", NullableString(foreclosureCase.DiscussedSolutionWithSrvcrInd));
                sqlParam[81] = new SqlParameter("@pi_worked_with_another_agency_ind", NullableString(foreclosureCase.WorkedWithAnotherAgencyInd));
                sqlParam[82] = new SqlParameter("@pi_contacted_srvcr_recently_ind", NullableString(foreclosureCase.ContactedSrvcrRecentlyInd));
                sqlParam[83] = new SqlParameter("@pi_has_workout_plan_ind", NullableString(foreclosureCase.HasWorkoutPlanInd));
                sqlParam[84] = new SqlParameter("@pi_srvcr_workout_plan_current_ind", NullableString(foreclosureCase.SrvcrWorkoutPlanCurrentInd));
                sqlParam[85] = new SqlParameter("@pi_primary_residence_ind", NullableString(foreclosureCase.PrimaryResidenceInd));
                sqlParam[86] = new SqlParameter("@pi_realty_company", NullableString(foreclosureCase.RealtyCompany));
                sqlParam[87] = new SqlParameter("@pi_property_cd", NullableString(foreclosureCase.PropertyCd));
                sqlParam[88] = new SqlParameter("@pi_for_sale_ind", NullableString(foreclosureCase.ForSaleInd));
                ...
                sqlParam[93] = new SqlParameter("@pi_military_service_cd", NullableString(foreclosureCase.MilitaryServiceCd));
                sqlParam[94] = new SqlParameter("@pi_household_gross_annual_income_amt", foreclosureCase.HouseholdGrossAnnualIncomeAmt);
                sqlParam[95] = new SqlParameter("@pi_intake_credit_score", NullableString(foreclosureCase.IntakeCreditScore));
                sqlParam[96] = new SqlParameter("@pi_Intake_credit_bureau_cd ", NullableString(foreclosureCase.IntakeCreditBureauCd));
        ...
        {            
            ...
            try
            {
                ...
                sqlParam[19] = new SqlParameter("@pi_counseling_duration_cd", NullableString(foreclosureCase.CounselingDurationCd));
                sqlParam[20] = new SqlParameter("@pi_gender_cd", NullableString(foreclosureCase.GenderCd));
                sqlParam[21] = new SqlParameter("@pi_borrower_fname", NullableString(foreclosureCase.BorrowerFname));
                sqlParam[22] = new SqlParameter("@pi_borrower_lname", NullableString(foreclosureCase.BorrowerLname));
                sqlParam[23] = new SqlParameter("@pi_borrower_mname", NullableString(foreclosureCase.BorrowerMname));
                sqlParam[24] = new SqlParameter("@pi_mother_maiden_lname", NullableString(foreclosureCase.MotherMaidenLname));
                sqlParam[25] = new SqlParameter("@pi_borrower_ssn", NullableString(foreclosureCase.BorrowerSsn));
                sqlParam[26] = new SqlParameter("@pi_borrower_last4_SSN", NullableString(foreclosureCase.BorrowerLast4Ssn));
                sqlParam[27] = new SqlParameter("@pi_borrower_DOB", NullableDateTime(foreclosureCase.BorrowerDob));
                sqlParam[28] = new SqlParameter("@pi_co_borrower_fname", NullableString(foreclosureCase.CoBorrowerFname));
                sqlParam[29] = new SqlParameter("@pi_co_borrower_lname", NullableString(foreclosureCase.CoBorrowerLname));
                sqlParam[30] = new SqlParameter("@pi_co_borrower_mname", NullableString(foreclosureCase.CoBorrowerMname));
                sqlParam[31] = new SqlParameter("@pi_co_borrower_ssn", NullableString(foreclosureCase.CoBorrowerSsn));
                sqlParam[32] = new SqlParameter("@pi_co_borrower_last4_SSN", NullableString(foreclosureCase.CoBorrowerLast4Ssn));
                sqlParam[33] = new SqlParameter("@pi_co_borrower_DOB", NullableDateTime(foreclosureCase.CoBorrowerDob));
                sqlParam[34] = new SqlParameter("@pi_primary_contact_no", NullableString(foreclosureCase.PrimaryContactNo));
                sqlParam[35] = new SqlParameter("@pi_second_contact_no", NullableString(foreclosureCase.SecondContactNo));
                sqlParam[36] = new SqlParameter("@pi_email_1", NullableString(foreclosureCase.Email1));
                sqlParam[37] = new SqlParameter("@pi_email_2", NullableString(foreclosureCase.Email2));
                sqlParam[38] = new SqlParameter("@pi_contact_addr1", NullableString(foreclosureCase.ContactAddr1));
                sqlParam[39] = new SqlParameter("@pi_contact_addr2", NullableString(foreclosureCase.ContactAddr2));
                sqlParam[40] = new SqlParameter("@pi_contact_city", NullableString(foreclosureCase.ContactCity));
                sqlParam[41] = new SqlParameter("@pi_contact_state_cd", NullableString(foreclosureCase.ContactStateCd));
                sqlParam[42] = new SqlParameter("@pi_contact_zip", NullableString(foreclosureCase.ContactZip));
                sqlParam[43] = new SqlParameter("@pi_contact_zip_plus4", NullableString(foreclosureCase.ContactZipPlus4));
                sqlParam[44] = new SqlParameter("@pi_prop_addr1", NullableString(foreclosureCase.PropAddr1));
                sqlParam[45] = new SqlParameter("@pi_prop_addr2", NullableString(foreclosureCase.PropAddr2));
                sqlParam[46] = new SqlParameter("@pi_prop_city", NullableString(foreclosureCase.PropCity));
                sqlParam[47] = new SqlParameter("@pi_prop_state_cd", NullableString(foreclosureCase.PropStateCd));
                sqlParam[48] = new SqlParameter("@pi_prop_zip", NullableString(foreclosureCase.PropZip));
                sqlParam[49] = new SqlParameter("@pi_prop_zip_plus_4", NullableString(foreclosureCase.PropZipPlus4));
                sqlParam[50] = new SqlParameter("@pi_bankruptcy_ind", NullableString(foreclosureCase.BankruptcyInd));
                sqlParam[51] = new SqlParameter("@pi_bankruptcy_attorney", NullableString(foreclosureCase.BankruptcyAttorney));
                sqlParam[52] = new SqlParameter("@pi_bankruptcy_pmt_current_ind", NullableString(foreclosureCase.BankruptcyPmtCurrentInd));
                ...
                sqlParam[61] = new SqlParameter("@pi_fc_notice_received_ind", NullableString(foreclosureCase.FcNoticeReceiveInd));
                sqlParam[62] = new SqlParameter("@pi_funding_consent_ind", NullableString(foreclosureCase.FundingConsentInd));
                sqlParam[63] = new SqlParameter("@pi_servicer_consent_ind", NullableString(foreclosureCase.ServicerConsentInd));
                sqlParam[64] = new SqlParameter("@pi_agency_media_interest_ind", NullableString(foreclosureCase.AgencyMediaInterestInd));
                sqlParam[65] = new SqlParameter("@pi_agency_success_story_ind", NullableString(foreclosureCase.AgencySuccessStoryInd));
                sqlParam[66] = new SqlParameter("@pi_borrower_disabled_ind", NullableString(foreclosureCase.BorrowerDisabledInd));
                sqlParam[67] = new SqlParameter("@pi_co_borrower_disabled_ind", NullableString(foreclosureCase.CoBorrowerDisabledInd));
                sqlParam[68] = new SqlParameter("@pi_summary_sent_other_cd", NullableString(foreclosureCase.SummarySentOtherCd));
                ...
                sqlParam[72] = new SqlParameter("@pi_loan_dflt_reason_notes", NullableString(foreclosureCase.LoanDfltReasonNotes));
                sqlParam[73] = new SqlParameter("@pi_action_items_notes", NullableString(foreclosureCase.ActionItemsNotes));
                ...
                sqlParam[82] = new SqlParameter("@pi_discussed_solution_with_srvcr_ind", NullableString(foreclosureCase.DiscussedSolutionWithSrvcrInd));
                sqlParam[83] = new SqlParameter("@pi_worked_with_another_agency_ind", NullableString(foreclosureCase.WorkedWithAnotherAgencyInd));
                sqlParam[84] = new SqlParameter("@pi_contacted_srvcr_recently_ind", NullableString(foreclosureCase.ContactedSrvcrRecentlyInd));
                sqlParam[85] = new SqlParameter("@pi_has_workout_plan_ind", NullableString(foreclosureCase.HasWorkoutPlanInd));
                sqlParam[86] = new SqlParameter("@pi_srvcr_workout_plan_current_ind", NullableString(foreclosureCase.SrvcrWorkoutPlanCurrentInd));
                sqlParam[87] = new SqlParameter("@pi_primary_residence_ind", NullableString(foreclosureCase.PrimaryResidenceInd));
                sqlParam[88] = new SqlParameter("@pi_realty_company", NullableString(foreclosureCase.RealtyCompany));
                sqlParam[89] = new SqlParameter("@pi_property_cd", NullableString(foreclosureCase.PropertyCd));
                sqlParam[90] = new SqlParameter("@pi_for_sale_ind", NullableString(foreclosureCase.ForSaleInd));
                ...
                sqlParam[95] = new SqlParameter("@pi_military_service_cd", NullableString(foreclosureCase.MilitaryServiceCd));
                sqlParam[96] = new SqlParameter("@pi_household_gross_annual_income_amt", foreclosureCase.HouseholdGrossAnnualIncomeAmt);
                sqlParam[97] = new SqlParameter("@pi_intake_credit_score", NullableString(foreclosureCase.IntakeCreditScore));
