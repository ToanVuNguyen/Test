    ...
    public class ForeclosureCaseSetDAO : BaseDAO
    {
        ...
        public void UpdateCaseLoan(CaseLoanDTO caseLoan)
        {
            ...
            try
            {
                ...
                sqlParam[0] =  new SqlParameter("@pi_case_loan_id", caseLoan.CaseLoanId);
                sqlParam[1] = new SqlParameter("@pi_fc_id", caseLoan.FcId);
                sqlParam[2] = new SqlParameter("@pi_servicer_id", caseLoan.ServicerId);
                sqlParam[3] = new SqlParameter("@pi_other_servicer_name", caseLoan.OtherServicerName);
                sqlParam[4] = new SqlParameter("@pi_acct_num", caseLoan.AcctNum);
                sqlParam[5] = new SqlParameter("@pi_loan_1st_2nd_cd", caseLoan.Loan1st2nd);
                sqlParam[6] = new SqlParameter("@pi_mortgage_type_cd", caseLoan.MortgageTypeCd);                
                ...
                sqlParam[19] = new SqlParameter("@pi_investor_loan_num", caseLoan.InvestorLoanNum);
