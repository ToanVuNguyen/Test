...
namespace HPF.FutureState.DataAccess
{
    public class SecurityDAO: BaseDAO
    {
        ...
        public void UpdateWebUser(UserDTO webUser)
        {
            ...
            sqlParam[2] = new SqlParameter("@pi_password",webUser.Password);
            sqlParam[3] = new SqlParameter("@pi_active_ind",webUser.IsActivate);
            sqlParam[4] = new SqlParameter("@pi_user_role_str_tbd", webUser.UserRole);
            sqlParam[5] = new SqlParameter("@pi_fname",webUser.FirstName); 
            sqlParam[6] = new SqlParameter("@pi_lname",webUser.LastName);
            sqlParam[7] = new SqlParameter("@pi_email" ,webUser.Email);
            sqlParam[8] = new SqlParameter("@pi_phone" ,webUser.Phone);
            sqlParam[9] = new SqlParameter("@pi_user_type", null);
            sqlParam[10] = new SqlParameter("@pi_last_login_dt",NullableDateTime(webUser.LastLogin));
