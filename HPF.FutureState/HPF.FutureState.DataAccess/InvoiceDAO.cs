    ...
    public class InvoiceDAO : BaseDAO
    {
        ...
        public ForeclosureCaseDraftDTOCollection InvoiceCaseSearch(InvoiceCaseSearchCriteriaDTO searchCriteria)
        {
            ...
            try
            {
                ...
                sqlParam[8] = new SqlParameter("@pi_funding_consent_ind", searchCriteria.IgnoreFundingConsent == CustomBoolean.None ? null : searchCriteria.IgnoreFundingConsent.ToString());
                sqlParam[9] = new SqlParameter("@pi_max_number_cases", searchCriteria.MaxNumOfCases == int.MinValue ? null : searchCriteria.MaxNumOfCases.ToString());
                sqlParam[10] = new SqlParameter("@pi_gender_cd", searchCriteria.Gender == "-1" ? null : searchCriteria.Gender);
                sqlParam[11] = new SqlParameter("@pi_race_cd", searchCriteria.Race == "-1" ? null : searchCriteria.Race);
                sqlParam[12] = new SqlParameter("@pi_ethnicity_cd", searchCriteria.Hispanic == CustomBoolean.None ? null : searchCriteria.Hispanic.ToString());
                sqlParam[13] = new SqlParameter("@pi_household_cd", searchCriteria.HouseholdCode == "-1" ? null : searchCriteria.HouseholdCode);
                sqlParam[14] = new SqlParameter("@pi_city", searchCriteria.City == string.Empty ? null : searchCriteria.City);
                sqlParam[15] = new SqlParameter("@pi_state_cd", searchCriteria.State == "-1" ? null : searchCriteria.State);
                sqlParam[16] = new SqlParameter("@pi_min_age", searchCriteria.Age.Min == int.MinValue ? null : searchCriteria.Age.Min.ToString());
                sqlParam[17] = new SqlParameter("@pi_max_age", searchCriteria.Age.Max == int.MinValue ? null : searchCriteria.Age.Max.ToString());
                sqlParam[18] = new SqlParameter("@pi_min_gross_annual_income", searchCriteria.HouseholdGrossAnnualIncome.Min == double.MinValue ? null : searchCriteria.HouseholdGrossAnnualIncome.Min.ToString());
                sqlParam[19] = new SqlParameter("@pi_max_gross_annual_income", searchCriteria.HouseholdGrossAnnualIncome.Max == double.MinValue ? null : searchCriteria.HouseholdGrossAnnualIncome.Max.ToString());
                //</Parameter>
                command.Parameters.AddRange(sqlParam);
                command.CommandType = CommandType.StoredProcedure;
