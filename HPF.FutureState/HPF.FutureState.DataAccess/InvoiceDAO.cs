    ...
    public class InvoiceDAO : BaseDAO
    {
        ...
        public ForeclosureCaseDraftDTOCollection InvoiceCaseSearch(InvoiceCaseSearchCriteriaDTO searchCriteria)
        {
            ...
            try
            {
                ...
                sqlParam[15] = new SqlParameter("@pi_min_age", searchCriteria.Age.Min == int.MinValue ? null : searchCriteria.Age.Min.ToString());
                sqlParam[16] = new SqlParameter("@pi_max_age", searchCriteria.Age.Max == int.MinValue ? null : searchCriteria.Age.Max.ToString());
                sqlParam[17] = new SqlParameter("@pi_min_gross_annual_income", searchCriteria.HouseholdGrossAnnualIncome.Min == double.MinValue ? null : searchCriteria.HouseholdGrossAnnualIncome.Min.ToString());
                sqlParam[18] = new SqlParameter("@pi_max_gross_annual_income", searchCriteria.HouseholdGrossAnnualIncome.Max == double.MinValue ? null : searchCriteria.HouseholdGrossAnnualIncome.Max.ToString());
