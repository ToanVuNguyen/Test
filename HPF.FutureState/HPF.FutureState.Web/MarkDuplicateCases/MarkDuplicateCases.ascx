<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MarkDuplicateCases.ascx.cs" Inherits="HPF.FutureState.Web.MarkDuplicateCases.MarkDuplicateCases" %>
<table style="width:100%;">
    ...
    <tr>
        <td>
            &nbsp;</td>
        <td align="center">
            <h3>Mark Duplicate Foreclosure Cases</h3>
