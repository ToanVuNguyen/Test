<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CaseDetail.ascx.cs"
    Inherits="HPF.FutureState.Web.ForeclosureCaseDetail.ForeclosureCaseDetail" %>
...
<table style="width: 100%;">
        ...
        <td>
            <table style="width: 100%; border-bottom-style: none;">
                <tr>
                    ...
                    <td align="right">
                        <asp:Button ID="btn_Save" runat="server" Text="Save" CssClass="MyButton" OnClick="btn_Save_Click" />
                    </td>
                </tr>
                <tr>
    ...
    <tr>
        <td align="right">
            <asp:Button ID="btn_Save0" runat="server" Text="Save" CssClass="MyButton" OnClick="btn_Save_Click" />
        </td>
    </tr>
    <tr>
        <td align="right">
