...
namespace HPF.FutureState.Common.DataTransferObjects
{
    public class PostModInclusionDTO : BaseDTO
    {
        ...
        public string FannieMaeLoanNum { get; set; }
        ...
        [StringRequiredValidator(Ruleset = Constant.RULESET_MIN_REQUIRE_FIELD)]
        [NullableOrStringLengthValidator(true, 60, "Trial/Mod Type", Ruleset = Constant.RULESET_LENGTH)]
        ...
        public const int TotalFields = 43;
        ...
        public const int TrialStartDtPos = 5;
        public const int ModConversionDtPos = 6;
        public const int AcctNumPos = 7;
        public const int AchFlagPos = 8;
        public const int TrialModPmtAmtPos = 9;
        public const int NextPmtDueDtPos = 10;
        public const int LastPmtAppliedDtPos = 11;
        public const int UnpaidPrincipalBalAmtPos = 12;
        public const int DefaultReasonPos = 13;
        public const int SpanishIndPos = 14;
        public const int BorrowerFNamePos = 15;
        public const int BorrowerLNamePos = 16;
        public const int CoBorrowerFNamePos = 17;
        public const int CoBorrowerLNamePos = 18;
        public const int PropAddr1Pos = 19;
        public const int PropAddr2Pos = 20;
        public const int PropCityPos = 21;
        public const int PropStateCdPos = 22;
        public const int PropZipPos = 23;
        public const int ContactAddr1Pos = 24;
        public const int ContactAddr2Pos = 25;
        public const int ContactCityPos = 26;
        public const int ContactStateCdPos = 27;
        public const int ContactZipPos = 28;
        public const int BorrowerHomeContactNoPos = 29;
        public const int BorrowerOffice1ContactNoPos = 30;
        public const int BorrowerOffice2ContactNoPos = 31;
        public const int BorrowerOtherContactNoPos = 32;
        public const int BorrowerCell1ContactNoPos = 33;
        public const int BorrowerCell2ContactNoPos = 34;
        public const int BorrowerEmailPos = 35;
        public const int CoBorrowerHomeContactNoPos = 36;
        public const int CoBorrowerOffice1ContactNoPos = 37;
        public const int CoBorrowerOffice2ContactNoPos = 38;
        public const int CoBorrowerOtherContactNoPos = 39;
        public const int CoBorrowerCell1ContactNoPos = 40;
        public const int CoBorrowerCell2ContactNoPos = 41;
        public const int CoBorrowerEmailPos = 42;
