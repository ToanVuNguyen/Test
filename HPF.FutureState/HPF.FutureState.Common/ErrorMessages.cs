    ...
    public static class ErrorMessages
    {
        ...
        private static void LoadErrorMessageDict()
        {
            if (errorMessageDict.Count == 0)
            {
                ...
                errorMessageDict.Add(ERR1173, "An update was submitted without a PpcId. All updates require a HPF PpcId. Please correct and resubmit the case.");
                errorMessageDict.Add(ERR1174, "An invalid AgencyID was provided for the Corresponding PpcId.  Your agency does not own this pre-purchase case. ");
                errorMessageDict.Add(ERR1175, "An invalid PpcId was provided.  Please correct the PpcId and resend the pre-purchase case.");
