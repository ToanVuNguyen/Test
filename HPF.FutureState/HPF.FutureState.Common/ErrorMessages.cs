...
namespace HPF.FutureState.Common
{
    public static class ErrorMessages
    {
        ...
        public const string ERR0685 = "ERR0685";
        ...
        private static void LoadErrorMessageDict()
        {
            if (errorMessageDict.Count == 0)
            {
                ...
                errorMessageDict.Add(ERR0005, "BorrowerMName has a maximum length of 30 characters.");
                errorMessageDict.Add(ERR0006, "MotherMaidenLName has a maximum length of 30 characters.");
                errorMessageDict.Add(ERR0007, "BorrowerSsn has a maximum length of 9 characters.");
                errorMessageDict.Add(ERR0008, "BorrowerLast4Ssn has a maximum length of 4 characters.");
                errorMessageDict.Add(ERR0009, "CoBorrowerFName has a maximum length of 30 characters.");
                errorMessageDict.Add(ERR0010, "CoBorrowerLName has a maximum length of 30 characters.");
                ...
                errorMessageDict.Add(ERR0028, "BankruptcyAttorney has a maximum length of 50 characters.");
                errorMessageDict.Add(ERR0029, "BankruptcyCurrentInd must be either a Y, N or a blank.");
                errorMessageDict.Add(ERR0030, "HispanicInd must be either a Y, N or a blank.");
                errorMessageDict.Add(ERR0031, "FcNoticeReceivedInd must be either a Y, N or a blank.");
                errorMessageDict.Add(ERR0032, "ServicerConsent must be either a Y or N.");
                errorMessageDict.Add(ERR0033, "FundingConsent must be either a Y or N.");
                errorMessageDict.Add(ERR0034, "AgencyMediaInterestInd must be either a Y, N or a blank.");
                errorMessageDict.Add(ERR0035, "AgencySuccessStoryInd must be either a Y, N or a blank.");
                errorMessageDict.Add(ERR0036, "BorrowerDisabledInd must be either a Y, N or a blank.");
                errorMessageDict.Add(ERR0037, "CoBorrowerDisabledInd must be either a Y, N or a blank.");
                errorMessageDict.Add(ERR0038, "LoanDfltReasonNotes has a maximum length of 8000 characters.");
                errorMessageDict.Add(ERR0039, "ActionItemsNotes has a maximum length of 8000 characters.");
                errorMessageDict.Add(ERR0040, "FollowupNotes has a maximum length of 8000 characters.");
                ...
                errorMessageDict.Add(ERR0050, "HasWorkoutPlanInd must be either a Y, N or a blank.");
                errorMessageDict.Add(ERR0051, "SrvcrWorkoutPlanCurrentInd must be either a Y, N or a blank.");
                errorMessageDict.Add(ERR0052, "OwnerOccupiedInd must be either a Y or N.");
                errorMessageDict.Add(ERR0053, "PrimaryResidenceInd must be either a Y or N.");
                errorMessageDict.Add(ERR0054, "RealtyCompany has a maximum length of 50 characters.");
                errorMessageDict.Add(ERR0055, "ForSaleInd must be either a Y or N.");
                errorMessageDict.Add(ERR0056, "IntakeCreditScore has a maximum length of 4 characters.");
                errorMessageDict.Add(ERR0057, "OtherServicerName has a maximum length of 50 characters.");
                errorMessageDict.Add(ERR0058, "AcctNum has a maximum length of 30 characters.");
                errorMessageDict.Add(ERR0059, "ArmResetInd must be either a Y, N or a blank.");
                errorMessageDict.Add(ERR0060, "OriginatingLenderName has a maximum length of 50 characters.");
                errorMessageDict.Add(ERR0061, "OrigMortgageCoFdicNcuaNum has a maximum length of 20 characters.");
                errorMessageDict.Add(ERR0062, "OrigMortgageCoName has a maximum length of 50 characters.");
                errorMessageDict.Add(ERR0063, "OriginalLoanNum has a maximum length of 30 characters.");
                errorMessageDict.Add(ERR0064, "CurrentServicerFdicNcuaNum has a maximum length of 30 characters.");
                errorMessageDict.Add(ERR0065, "InvestorLoanNum has a maximum length of 30 characters.");
                errorMessageDict.Add(ERR0066, "InvestorNum has a maximum length of 30 characters.");
                errorMessageDict.Add(ERR0067, "InvestorName has a maximum length of 50 characters.");
                errorMessageDict.Add(ERR0068, "NonprofitreferralKeyNum has a maximum length of 10 characters.");
                errorMessageDict.Add(ERR0069, "ExtRefOtherName has a maximum length of 50 characters.");
                ...
                errorMessageDict.Add(ERR0087, "MortgagePmtRatio must be a valid number with 1 decimal place, no larger than 999,999.9");
                ...
                errorMessageDict.Add(ERR0680, "Unable to process the reconciliation file. The HPF Internal Case ID in row {0} does not match the case ID on the record retrieved by the HPF Invoice Case ID in this row.");
                ...
                errorMessageDict.Add(ERR0685, "The Reconcilliation File must contain a valid path and file name.");
                ...
                errorMessageDict.Add(ERR1133, "An ApplicantId is required.");
                ...
                errorMessageDict.Add(ERR1157, "A PropStateCd is required!");
                ...
                errorMessageDict.Add(ERR1161, "A MailStateCd is required!");
                ...
                errorMessageDict.Add(ERR1165, "A null applicant or pre-purchase case is not allowed to insert.");
                ...
                errorMessageDict.Add(ERR1171, "MailZip and MailStateCd must be a valid state-zip combinaton.");
                errorMessageDict.Add(ERR1172, "MailZip must contain 5 numeric digits.");
                errorMessageDict.Add(ERR1173, "An update was submitted. There is one pre-purchase case which has the same agency_case_num. Please correct and resubmit the case.");
                errorMessageDict.Add(ERR1174, "An invalid AgencyID was provided for the Corresponding ApplicantId.  Your agency does not own this pre-purchase case. ");
                errorMessageDict.Add(ERR1176, "A ChgLstUserId is required.");
                errorMessageDict.Add(ERR1177, "A PrimaryContactNo is required!");
