...
using HPF.FutureState.Common.Properties;
using Microsoft.Practices.EnterpriseLibrary.ExceptionHandling;

namespace HPF.FutureState.Common.Utils.Exceptions
{
    public class HPFTextExceptionFormatter : ExceptionFormatter
    {
        ...
        public HPFTextExceptionFormatter(TextWriter writer, Exception exception)
        ...
        public HPFTextExceptionFormatter(TextWriter writer, Exception exception, Guid handlingInstanceId)
