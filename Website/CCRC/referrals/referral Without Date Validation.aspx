...
<%
	...
	Dim contactedServicerInd, referralSourceTypeCode
	...
	<table border="0" class="pageBody" ID="Table2" width="600">
		<tr><td><h1>Referral: <%=varloanId%>/<%=zipCode%><%=IIf(dupeInd.ToString() = "Y", ": Duplicate", "")%></h1></td></tr>
				...
				<tr id="existingServicerRow" name="existingServicerRow">
					...
					<td>
						<%=servicerSelect("servicer", servicer, disable, "true", "Servicer", "Servicer is required", RsServicers)%>&nbsp;
...
-->							
				...
				<%End If%>
				<tr>
					<td><font class="label" title="">Account #:</font></td>
					<td>
				...
				<tr>
					...
					<td>
						...
						<%=listPriceAmt%>
						<%Else%>
						<input maxlength="15" detectChanges type="text" id="listPriceAmt" name="listPriceAmt" value="<%=listPriceAmt%>" required="false" datatype="positiveinteger" errorlbl="" errormsg="">
						<%End If%>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td><font class="label" title="">PITI at Intake:</font></td>
					<td>
						<%If disable Then%>
						<%=pitiAmt%>
						<%Else%>
						<input maxlength="15" detectChanges type="text" id="pitiAmt" name="pitiAmt" value="<%=pitiAmt%>" required="true" datatype="positiveinteger" errorlbl="PITI at Intake" errormsg="PITI at Intake is required and must be a positive integer.">
						<%End If%>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<input detectChanges type="text" id="miName" name="miName" style="width: 20px" maxlength="1" value="<%=miName%>">
						<%End If%>
					</td>
				</tr>
				<tr>
...
-->						
				...
				<tr>
					...
					<td>
						<%If disable Then%>
							<%=emailAddr%>
						<%Else%>
							<input detectChanges maxlength="50" type="text" id="Text2" name="emailAddr" value="<%=emailAddr%>" datatype="anytext" required="true"  errorlbl="Email Address" errormsg="Email Address is required.">
						<%End If%>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<%=referralDate%>
						<%Else%>
						<input detectChanges type="text" id="referralDate" name="referralDate" value="<%=referralDate%>" datatype="date" errorlbl="Referral Received Date" errormsg="Referral received date is invalid.">
						<%
				...
				<tr>
					<td><font class="label" title="">Loan Status at First Contact:</font></td>
					<td><%=firstContactStatusTypeSelect("firstContactStatusType", firstContactStatusTypeCode, disable, "true", "First Contact Status Type", "")%></td>
				</tr>
...
-->				
			...
			<tr><td><table ID="Table1">
					<tr>
						...
						<td valign="bottom" bgcolor="#ffff33"><font class="label" title="">Did you update length of counseling?</FONT></SPAN></font></td>
						<td>
