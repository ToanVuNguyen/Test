...
'							If Rs2.Fields("ACCT_PRD").Value & "" <> "" And Not IsNull(Rs2.Fields("ACCT_PRD").Value) Then
							...
							Else
								If Rs2.Fields("ACCT_PRD").Value = acctPrd Then
									'Response.write("Get_Referrals_AutoEmail - referralId")
									'Response.write(referralId)
									'Response.write("acctPrd ")
									'Response.write(acctPrd )
									'Response.write("ACCT_PRD")	
									'Response.write(Rs2.Fields("ACCT_PRD").Value)
									'Response.write("ref_results_type_hist")
									'Response.write(Rs2.Fields("ref_results_type_hist").Value)
									'Response.write("+")
