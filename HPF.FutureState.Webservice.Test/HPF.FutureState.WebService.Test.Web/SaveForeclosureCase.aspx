...
<asp:Content ID="ContentBody" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <asp:GridView ID="grdvCaseLoan" runat="server" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="MortgageProgramCd" >  
                ...
                <ItemTemplate>
                    <asp:Label ID="Label200" runat="server" Text='<%# Bind("MortgageProgramCd") %>'></asp:Label>
                </ItemTemplate>                
                
            </asp:TemplateField>
             <asp:TemplateField HeaderText="ArmRateAdjustDt" >  
                <EditItemTemplate>
                    <asp:TextBox ID="txtArmRateAdjustDt" runat="server" Text='<%# Eval("ArmRateAdjustDt") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtArmRateAdjustDt" runat="server"></asp:TextBox> </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label201" runat="server" Text='<%# Bind("ArmRateAdjustDt") %>'></asp:Label>
                </ItemTemplate>                                
            </asp:TemplateField>            
             <asp:TemplateField HeaderText="ArmLockDuration" >  
                <EditItemTemplate>
                    <asp:TextBox ID="txtArmLockDuration" runat="server" Text='<%# Eval("ArmLockDuration") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtArmLockDuration" runat="server"></asp:TextBox> </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label202" runat="server" Text='<%# Bind("ArmLockDuration") %>'></asp:Label>
                </ItemTemplate>                                
            </asp:TemplateField>            
            <asp:TemplateField HeaderText="LoanLookupCd" >  
                <EditItemTemplate>
                    <asp:TextBox ID="txtLoanLookupCd" runat="server" Text='<%# Eval("LoanLookupCd") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtLoanLookupCd" runat="server"></asp:TextBox> </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label203" runat="server" Text='<%# Bind("LoanLookupCd") %>'></asp:Label>
                </ItemTemplate>                                
            </asp:TemplateField>
            <asp:TemplateField HeaderText="ThirtyDaysLatePastYrInd" >  
                <EditItemTemplate>
                    <asp:TextBox ID="txtThirtyDaysLatePastYrInd" runat="server" Text='<%# Eval("ThirtyDaysLatePastYrInd") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtThirtyDaysLatePastYrInd" runat="server"></asp:TextBox> </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label303" runat="server" Text='<%# Bind("ThirtyDaysLatePastYrInd") %>'></asp:Label>
                </ItemTemplate>                                
            </asp:TemplateField>
            <asp:TemplateField HeaderText="PmtMissLessOneYrLoanInd" >  
                <EditItemTemplate>
                    <asp:TextBox ID="txtPmtMissLessOneYrLoanInd" runat="server" Text='<%# Eval("PmtMissLessOneYrLoanInd") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtPmtMissLessOneYrLoanInd" runat="server"></asp:TextBox> </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label204" runat="server" Text='<%# Bind("PmtMissLessOneYrLoanInd") %>'></asp:Label>
                </ItemTemplate>                                
            </asp:TemplateField>
            <asp:TemplateField HeaderText="SufficientIncomeInd" >  
                <EditItemTemplate>
                    <asp:TextBox ID="txtSufficientIncomeInd" runat="server" Text='<%# Eval("SufficientIncomeInd") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtSufficientIncomeInd" runat="server"></asp:TextBox> </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label205" runat="server" Text='<%# Bind("SufficientIncomeInd") %>'></asp:Label>
                </ItemTemplate>                                
            </asp:TemplateField>
            <asp:TemplateField HeaderText="LongTermAffordInd" >  
                <EditItemTemplate>
                    <asp:TextBox ID="txtLongTermAffordInd" runat="server" Text='<%# Eval("LongTermAffordInd") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtLongTermAffordInd" runat="server"></asp:TextBox> </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label206" runat="server" Text='<%# Bind("LongTermAffordInd") %>'></asp:Label>
                </ItemTemplate>                                
            </asp:TemplateField>
            <asp:TemplateField HeaderText="HarpEligibleInd" >  
                <EditItemTemplate>
                    <asp:TextBox ID="txtHarpEligibleInd" runat="server" Text='<%# Eval("HarpEligibleInd") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtHarpEligibleInd" runat="server"></asp:TextBox> </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label207" runat="server" Text='<%# Bind("HarpEligibleInd") %>'></asp:Label>
                </ItemTemplate>                                
            </asp:TemplateField>
            <asp:TemplateField HeaderText="OrigPriorTo2009Ind" >  
                <EditItemTemplate>
                    <asp:TextBox ID="txtOrigPriorTo2009Ind" runat="server" Text='<%# Eval("OrigPriorTo2009Ind") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtOrigPriorTo2009Ind" runat="server"></asp:TextBox> </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label208" runat="server" Text='<%# Bind("OrigPriorTo2009Ind") %>'></asp:Label>
                </ItemTemplate>                                
            </asp:TemplateField>
            <asp:TemplateField HeaderText="PriorHampInd" >  
                <EditItemTemplate>
                    <asp:TextBox ID="txtPriorHampInd" runat="server" Text='<%# Eval("PriorHampInd") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtPriorHampInd" runat="server"></asp:TextBox> </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label209" runat="server" Text='<%# Bind("PriorHampInd") %>'></asp:Label>
                </ItemTemplate>                                
            </asp:TemplateField>
            <asp:TemplateField HeaderText="PrinBalWithinLimitInd" >  
                <EditItemTemplate>
                    <asp:TextBox ID="txtPrinBalWithinLimitInd" runat="server" Text='<%# Eval("PrinBalWithinLimitInd") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtPrinBalWithinLimitInd" runat="server"></asp:TextBox> </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label210" runat="server" Text='<%# Bind("PrinBalWithinLimitInd") %>'></asp:Label>
                </ItemTemplate>                                
            </asp:TemplateField>
            <asp:TemplateField HeaderText="HampEligibleInd" >  
                <EditItemTemplate>
                    <asp:TextBox ID="txtHampEligibleInd" runat="server" Text='<%# Eval("HampEligibleInd") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtHampEligibleInd" runat="server"></asp:TextBox> </FooterTemplate>
                <ItemTemplate>
    ...
    <br />
    <asp:Label ID="Label14" runat="server" Text="CreditReports"></asp:Label>
    <br />
    <asp:GridView ID="grdvCreditReport" runat="server" 
        ShowFooter = "True" 
        AutoGenerateColumns = "False"
        onrowediting="grdvCreditReport_RowEditing"
        OnRowCancelingEdit = "grdvCreditReport_RowCancelEditing"
        onrowupdating="grdvCreditReport_RowUpdating"
        onrowcommand="grdvCreditReportRowCommand" 
        onrowdeleting="grdvCreditReport_RowDeleting">
        <Columns>
            <asp:TemplateField HeaderText="Edit" ShowHeader="False">
                <EditItemTemplate>
                    <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="True" CommandName="Update" Text="Update"></asp:LinkButton>
            ...
            <asp:CommandField HeaderText="Delete" ShowDeleteButton="True" ShowHeader="false" />
            <asp:TemplateField HeaderText="CreditScore" >  
                <EditItemTemplate>
                    <asp:TextBox ID="txtCreditScore" runat="server" Text='<%# Eval("CreditScore") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtCreditScore" runat="server"></asp:TextBox> </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("CreditScore") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="CreditBureauCode" >  
                <EditItemTemplate>
                    <asp:TextBox ID="txtCreditBureauCd" runat="server" Text='<%# Eval("CreditBureauCd") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtCreditBureauCd" runat="server"></asp:TextBox> </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("CreditBureauCd") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="RevolvingBal" >  
                <EditItemTemplate>
                    <asp:TextBox ID="txtRevolvingBal" runat="server" Text='<%# Eval("RevolvingBal") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtRevolvingBal" runat="server"></asp:TextBox> </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label3" runat="server" Text='<%# Bind("RevolvingBal") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="RevolvingLimitAmount" >  
                <EditItemTemplate>
                    <asp:TextBox ID="txtRevolvingLimitAmt" runat="server" Text='<%# Eval("RevolvingLimitAmt") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtRevolvingLimitAmt" runat="server"></asp:TextBox> </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("RevolvingLimitAmt") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="InstallmentBal" >  
                <EditItemTemplate>
                    <asp:TextBox ID="txtInstallmentBal" runat="server" Text='<%# Eval("InstallmentBal") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtInstallmentBal" runat="server"></asp:TextBox> </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label5" runat="server" Text='<%# Bind("InstallmentBal") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="InstallmentLimitAmount" >  
                <EditItemTemplate>
                    <asp:TextBox ID="txtInstallmentLimitAmt" runat="server" Text='<%# Eval("InstallmentLimitAmt") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtInstallmentLimitAmt" runat="server"></asp:TextBox> </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label6" runat="server" Text='<%# Bind("InstallmentLimitAmt") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="CreditPullDt" >  
                <EditItemTemplate>
                    <asp:TextBox ID="txtCreditPullDt" runat="server" Text='<%# Eval("CreditPullDt") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtCreditPullDt" runat="server"></asp:TextBox> </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label7" runat="server" Text='<%# Bind("CreditPullDt") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Index" >  
                <FooterTemplate>
                ...
                <ItemTemplate>
                    <asp:Label ID="lblCreditReportId" runat="server" Text='<%# Bind("CreditReportId") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>    
    </asp:GridView>
