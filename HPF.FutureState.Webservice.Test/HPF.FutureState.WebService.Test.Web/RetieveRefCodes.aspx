<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RetieveRefCodes.aspx.cs" Inherits="HPF.FutureState.WebService.Test.Web.WebForm1" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
                    ...
                    <tr>
                        <td style="width: 150px">
                            <asp:Label CssClass="sidelinks" ID="Label30" runat="server" 
                                Text="Reference Code Name"></asp:Label>
                        </td>
                        <td style="width: 208px">
                            <asp:TextBox CssClass="Text" ID="txtRefCodeName" runat="Server" Width="193px"></asp:TextBox>
                        </td>
                        <td>
                            <asp:Button ID="btnSearch" runat="server" onclick="btnSearch_Click" 
                Text="Retrieve Ref Codes" CssClass="MyButton" />
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <asp:GridView ID="grdRefCodes" runat="server" CssClass="GridViewStyle" 
        CellPadding="4" ForeColor="#333333" Visible="False">
        <RowStyle BackColor="#EFF3FB" />
        <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
        <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
