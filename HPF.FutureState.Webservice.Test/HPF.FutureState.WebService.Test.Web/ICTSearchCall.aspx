<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ICTSearchCall.aspx.cs" Inherits="HPF.FutureState.WebService.Test.Web.ICTSearchCall" Title="HPF Webservice Test Application - Search Call"%>

<asp:Content ID="ContentBody" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
<div style="text-align:left"><h1>ICT Search Call</h1></div>
...
<asp:Button ID="btnSearch" runat="server" onclick="BtnSearch_Click" 
    Text="Search Call" CssClass="MyButton" />
    <br />
