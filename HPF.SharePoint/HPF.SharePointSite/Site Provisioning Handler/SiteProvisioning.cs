...
namespace HPF.SharePointSite
{
    public partial class SiteProvisioning
    {
        ...
        {            
            ...
            string xml = "<Field ID=\"9610DC6F-5631-4fd8-A60A-CA9ABCC5AFE6\" Type=\"Computed\" ReadOnly=\"TRUE\" Name=\"ListItemSelection\" DisplayName=\"Select\" Sortable=\"FALSE\" Filterable=\"FALSE\" EnableLookup=\"FALSE\" SourceID=\"http://schemas.microsoft.com/sharepoint/v3\" StaticName=\"ListItemSelection\"><FieldRefs><FieldRef Name=\"ID\" /><FieldRef Name=\"FSObjType\" /></FieldRefs><DisplayPattern><IfEqual><Expr1><LookupColumn Name=\"FSObjType\" /></Expr1><Expr2>0</Expr2><Then><HTML><![CDATA[<input type=\"checkbox\" ]]></HTML><HTML><![CDATA[LItemId=\"]]></HTML><Column Name=\"ID\" HTMLEncode=\"TRUE\" /><HTML><![CDATA[\" onclick=\"DocumentSelectionOnClick(this,']]></HTML><Column Name=\"ID\" HTMLEncode=\"TRUE\" /><HTML><![CDATA[');\"> ]]></HTML></Then></IfEqual></DisplayPattern></Field>";
